...
describe('Hooks', function () {
  let sendPaymentRequestToAPIStub = sinon.stub().callsFake((a, b) => Math.round(a) + Math.round(b));
  let logSpy;
  ...
  it('should verify if 120 is logged to the console after a call of sendPaymentRequestToApi', function () {
    sendPaymentRequestToAPIStub(100, 20);
    expect(logSpy.calledOnceWith('The total is: 120'));
  });

  it('should verify if 20 is logged to the console after a call of sendPaymentRequestToApi', function () {
    sendPaymentRequestToAPIStub(10, 10);
